    ...
    return (
        <div className='intro' id='about'>
            ...
            <div className='intro-details'>
                <p className='top-details'>After leaving an unfulfilling job in late 2021, I decided to try something that had always intrigued me: learning how to code. I started with Python and after picking up the basics, I realized the hours flew by as I was deeply absorbed in the logic and problem solving of programming. I could honestly say I was passionate about coding and web development and that this was the professional spark that had been missing in my past positions.</p>
