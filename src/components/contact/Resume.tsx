                    ...
                    <div className='resume-experience'>
                        ...
                        <div className='resume-experience-item'>
                            ...
                            <ul className='experience-duties'>
                                ...
                                <li>details schmetails details schmetails details schmetails details schmetails details schmetails details schmetails details schmetails details schmetails details schmetails details schmetails</li>
                            </ul>
                        </div>
                        <div className='resume-experience-item'>
                            <div className='experience-details'>
